...
import com.vynce.app.constants.MultilineLrcKey
import com.vynce.app.db.MusicDatabase
import com.vynce.app.db.entities.LyricsEntity
import com.vynce.app.db.entities.LyricsEntity.Companion.LYRICS_NOT_FOUND
...
class LyricsHelper @Inject constructor(
    ...
    private val lyricsProviders =
        listOf(LrcLibLyricsProvider, KuGouLyricsProvider)
