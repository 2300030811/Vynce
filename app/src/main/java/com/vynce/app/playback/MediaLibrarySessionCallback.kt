...
import com.vynce.app.constants.MediaSessionConstants
...
class MediaLibrarySessionCallback @Inject constructor(
    ...
    private fun com.vynce.app.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
        ...
        .setMediaMetadata(
           MediaMetadata.Builder()
                ...
                .setSubtitle(artists.joinToString { it.name })
                .setArtist(artists.joinToString { it.name })
                .setArtworkUri(thumbnailUrl?.replace("http://", "https://")?.toUri())
