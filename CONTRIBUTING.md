...
see https://github.com/Vynce/ffMetadataEx/blob/main/README.md#building

<br/><br/>

# Contributing to Vynce

## Translations

We use Weblate to translate Vynce. For more details or to get started,
visit [our Weblate page](https://hosted.weblate.org/projects/Vynce/).
...
- Prefix commits with tags, and provide descriptions if necessary. These are generally done in format:
  `tag: commit_name`. [Example](https://github.com/Vynce/Vynce/commit/798e8366227dd2cc38355224c733dbf7e8ffcee0)
...
- When porting/cherry-picking/stealing from other repositories or sources:
    - Maintain
      authorship. [Example](https://github.com/Vynce/Vynce/commit/b0dc59682190b41f0200e9df5174322acaa3d40d)
    - If this is not possible please provide the source in the commit
      description. [Example](https://github.com/Vynce/Vynce/pull/59/commits/e40325dd86ac2c30347cfd4f9e92bbf15a0d0c82)
...
- For multi-part commits where all parts are required for functionality, use
  `[1/2], [2/2], etc`. [See example](https://github.com/Vynce/Vynce/pull/59/commits)
...
| Vynce     | General changes that span across multiple modules                                               |
